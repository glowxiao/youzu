...
//安卓图标
/*$().ready(function(){
	$(".two1 input").mouseover(function(){
		$(".three1 i").show();
	});
	$(".two1 input").mouseout(function(){
	    $(".three1 i").hide();
	});
	$(".two2 input").mouseover(function(){
		$(".three2 i").show();
	});
	$(".two2 input").mouseout(function(){
	    $(".three2 i").hide();
	});
	$(".two3 input").mouseover(function(){
		$(".three3 i").show();
	});
	$(".two3 input").mouseout(function(){
	    $(".three3 i").hide();
	});
});*/
function An(){
